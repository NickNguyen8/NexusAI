...
const AppLibrary: React.FC<AppLibraryProps> = ({ apps, onSelectApp, onCreateApp, language }) => {
  ...
  return (
    <div className="flex-1 h-full overflow-y-auto bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 animate-[fadeIn_0.3s_ease-out] relative transition-colors duration-200">
      
      {/* Header Banner */}
      <div className="bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-800 p-8 md:p-12 transition-colors">
         <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-8 relative max-w-md">
                ...
                <input 
                    ...
                    className="w-full bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg pl-10 pr-4 py-3 text-gray-900 dark:text-gray-200 focus:outline-none focus:border-primary-600 focus:ring-1 focus:ring-primary-600 transition-all shadow-sm"
                    value={searchQuery}
      ...
      <div className="max-w-6xl mx-auto p-6 md:p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
          ...
          <button 
            ...
            className="group flex flex-col items-center justify-center p-6 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900/50 hover:border-primary-500/50 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-300 text-center min-h-[200px]"
          >
            <div className="w-14 h-14 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 group-hover:bg-gray-200 dark:group-hover:bg-gray-700 shadow-sm">
          ...
          {filteredApps.map((app) => {
            ...
            return (
              <button
                ...
                className="group relative flex flex-col p-6 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 hover:shadow-lg hover:-translate-y-1 transition-all duration-200 text-left shadow-sm"
              >
                <div className="flex items-start justify-between mb-4">
                    ...
                    <span className="bg-gray-100 dark:bg-gray-900 text-gray-600 dark:text-gray-500 text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider">{t.installed}</span>
                </div>
